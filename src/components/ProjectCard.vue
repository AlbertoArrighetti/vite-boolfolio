    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="d-flex gap-2 ">
          <span v-for="technology in card.technologies"  class="badge rounded-pill px-3 py-2 my_badge text-black " :style="{'background-color': technology.color ?? 'rgba(255, 255, 255, 0.6)' }">
            {{ technology.name }}
          </span>
        </div>
